        ...
        <div>
          <div className="bio-text">
            ...
            <div className="about-socials" style={{ display: 'flex', gap: '1rem', marginTop: '2rem', marginBottom: '2.5rem', flexWrap: 'wrap' }}>
              ...
              <a href="https://www.linkedin.com/in/rudrasgd" target="_blank" rel="noopener noreferrer" className="btn-secondary" style={{ padding: '0.8rem 1.5rem', fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="btn-secondary" style={{ padding: '0.8rem 1.5rem', fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
