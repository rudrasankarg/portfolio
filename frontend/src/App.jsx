    ...
    <div className={navActive ? 'nav-active' : ''}>
      ...
      <footer>
        <div className="footer-socials" style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', marginBottom: '1.5rem' }}>
          ...
          <a href="https://www.linkedin.com/in/rudra-sankar-ghosh-dastidar-5a0263326/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" style={{ display: 'flex', alignItems: 'center' }}>
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
